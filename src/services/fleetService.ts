...
const VEHICLE_FIELDS = 'id, name, type, plate, status, details, current_km, last_revision, brand, renavam, chassis, year, oil_type, location, nf_number, patrimonio_number, patrimonio_type';
