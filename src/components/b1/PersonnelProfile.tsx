        ...
        <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-rustic-border shadow-sm">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs">
                    ...
                    <div className={`p-3 rounded-xl ${isDateExpired(person.toxicological_expiry_date) ? 'bg-red-50' : 'bg-stone-50'}`}><span className="text-gray-400 block mb-1">Toxicológico Validade</span><span className="font-black">{formatLocalDate(person.toxicological_expiry_date)}</span></div>
