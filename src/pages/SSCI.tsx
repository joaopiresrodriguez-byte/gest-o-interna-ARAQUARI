            ...
            <header className="px-8 py-6 bg-[#1a1c1e] border-b border-[#2d2f31] shadow-xl flex flex-wrap justify-between items-center gap-4">
                <div className="flex flex-col">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="px-3 py-1 bg-purple-600 text-white text-[11px] font-black rounded-full shadow-[0_0_15px_rgba(147,51,234,0.5)] animate-pulse">v1.4.0 ULTRA</span>
                    </div>
